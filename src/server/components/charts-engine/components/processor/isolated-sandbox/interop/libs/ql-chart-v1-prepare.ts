...
const qlChartV1prepareAdapter: typeof qlModule = {
    ...
    buildGraph: (args) => JSON.parse(__libsQlChartV1_buildGraph(JSON.stringify(args))),
    buildChartsConfig: (args) =>
        JSON.parse(__libsQlChartV1_buildChartsConfig(JSON.stringify(args))),
    buildLibraryConfig: (args) =>
        JSON.parse(__libsQlChartV1_buildLibraryConfig(JSON.stringify(args))),
    buildD3Config: (args) => JSON.parse(__libsQlChartV1_buildD3Config(JSON.stringify(args))),
};
