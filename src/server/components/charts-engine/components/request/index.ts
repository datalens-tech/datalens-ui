...
type RequestOptions = RequiredUriUrl & AxiosRequestConfig;
...
export class Request {
    ...
    static request({
        ...
        function dataLengthCheck() {
            ...
            return function (chunk: Buffer | string) {
                ...
                if (
                    ...
                    abortController.abort({reason: error});
                }
            };
        }
        ...
        // } else {
        return this.directRequest({requestOptions: {...requestOptions, signal}, dataLengthCheck});
        // }
    }
    ...
    static async directRequest({
        ...
        dataLengthCheck: () => (data: Buffer | string) => void;
    }) {
