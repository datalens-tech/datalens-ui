...
class RoleTables extends React.Component {
    ...
    async componentDidMount() {
        ...
        table.on('click', 'tr.role-item button[data-item-base="false"]', (e) => {
          $('#dl-admin-form-title').text(i18n('change_role'));
        ...
        $('#dl-admin-form-success').on('click', (e) => {
          ...
          Utils.universalService({"action": "datalens", "method": "add_or_update_role", "data": [values]}).then((value) => {
            if(value.err) {
        ...
        $('#dl-admin-form-add').on('click', () => {
          $('#dl-admin-form-title').text(i18n('create_role'));
            ...
            <tbody>
              <tr>
                <td id="dl-admin-list" style={{"width": "100%", "verticalAlign": "top"}}>
                  <table id="roles-table" className="table table-hover">
                    <thead>
                        <tr>
                          <th scope="col">ID</th>
                ...
                <td id="dl-admin-form" style={{"width": "0%", "display": "none", "verticalAlign": "top"}}>
                  <div className="container">
                    ...
                    <div className="mb-3">
                      <label htmlFor="role_item_id" className="form-label">ID</label>
                      <input type="text" className="form-control" id="role_item_id" name="id" disabled readOnly />
                    </div>
                    <div className="mb-3">
                      <label htmlFor="role_item_name" className="form-label">{i18n('constant')}</label>
                      <input type="text" className="form-control" id="role_item_name" name='name'/>
                    </div>
                    <div className="mb-3">
                      <label htmlFor="role_item_name" className="form-label">{i18n('name')}</label>
                      <input type="text" className="form-control" id="role_item_description" name='description' />
                    </div>
