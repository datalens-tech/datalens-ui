...
export const GET_STRUCTURE_ITEMS_LOADING = Symbol('collections/GET_STRUCTURE_ITEMS_LOADING');
export const GET_STRUCTURE_ITEMS_SUCCESS = Symbol('collections/GET_STRUCTURE_ITEMS_SUCCESS');
export const GET_STRUCTURE_ITEMS_FAILED = Symbol('collections/GET_STRUCTURE_ITEMS_FAILED');
...
export const RESET_STRUCTURE_ITEMS = Symbol('collections/RESET_STRUCTURE_ITEMS');
