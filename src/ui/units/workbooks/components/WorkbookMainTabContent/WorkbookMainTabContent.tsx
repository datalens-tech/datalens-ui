...
import {GetEntryResponse, WorkbookWithPermissions} from 'shared/schema';
...
import {selectWorkbookEntriesIsLoading} from '../../store/selectors';
...
export const WorkbookMainTabContent = React.memo<Props>(
    ({entries, filters, workbookId, workbook}) => {
