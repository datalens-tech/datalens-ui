...
export const SET_DELEGATION_FROM_CONN_TO_SHARED_DATASET = Symbol(
    'dataset/SET_DELEGATION_FROM_CONN_TO_SHARED_DATASET',
);

export const SET_SELECTED_CONNECTION_DELEGATION = Symbol(
    'dataset/SET_SELECTED_CONNECTION_DELEGATION',
);
