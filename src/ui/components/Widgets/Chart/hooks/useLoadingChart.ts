    ...
    const handleChange = React.useCallback(
        (
            ...
            if (changedData.type === 'PARAMS_CHANGED') {
                ...
                // if widget has setting filtering chart & prev loading chart params contained actionParams & newPara all action params contain empty values, we need to clean it
