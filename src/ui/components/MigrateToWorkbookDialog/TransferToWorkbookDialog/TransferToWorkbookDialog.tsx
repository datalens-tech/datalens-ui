...
import './TransferToWorkbookDialog.scss';
...
export const DIALOG_TRANSFER_TO_WORKBOOK = Symbol('DIALOG_TRANSFER_TO_WORKBOOK');

export type OpenDialogTransferToWorkbookArgs = {
    id: typeof DIALOG_TRANSFER_TO_WORKBOOK;
    props: Props;
};
...
export const MigrateToWorkbookDialog: React.FC<Props> = ({
    ...
    }, [dispatch, isTransferToWorkbook, onSuccess, relationsGraph, targetEntry]);
...
DialogManager.registerDialog(DIALOG_TRANSFER_TO_WORKBOOK, MigrateToWorkbookDialog);
