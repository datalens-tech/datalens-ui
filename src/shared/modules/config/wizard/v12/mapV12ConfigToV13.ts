...
const integrateNewPaletteSystem = (config: V12ChartsConfig) => {
    // add indexes for colors & replace 'default-palette' with 'default-20'
    let extraSettings = config.extraSettings as V13CommonSharedExtraSettings;
...
export const mapV12ConfigToV13 = (config: V12ChartsConfig): V13ChartsConfig => {
    integrateNewPaletteSystem(config);
