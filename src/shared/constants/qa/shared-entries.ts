export const SharedEntriesPermissionsDialogQa = {
    ApplyBtn: 'shared-entries-permissions-dialog-apply',
    DelegateBtn: 'shared-entries-permissions-dialog-delegate',
    NotDelegateBtn: 'shared-entries-permissions-dialog-not-delegate',
} as const;
